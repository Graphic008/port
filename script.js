...
function start(){
    ...
    for(let i=0; i<slides.length; i++) {
        slides[i].style.width=(containerWidth/itemPreSlide)-margin + "px"
        slides[i].style.margin=margin/2 + "px";
            totalWidth += containerWidth/itemPreSlide;
    }

    sliderContainer.style.width=totalWidth +"px";

    slideDots=Math.ceil(slides.length/itemPreSlide);
